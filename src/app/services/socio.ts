...
export class SocioService {
  ...
  obtenerSociosPaginados(page: number, size: number, termino: string = ''): Observable<any> {
    return this.http.get<any>(`${this.baseUrl}/paginados?page=${page}&size=${size}&termino=${termino}`);
  }
}
